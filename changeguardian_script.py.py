...
get_ipython().system('pip install "pyarrow>=16.0.0" --upgrade -q')
get_ipython().system('pip install "scikit-learn>=1.5.0" --upgrade -q')
get_ipython().system('pip install langgraph networkx faiss-cpu sentence-transformers gradio psutil requests -q')
